package com.example.jose.myandroidfirebasedbreal;
...
import com.example.jose.myandroidfirebasedbreal.Model.Post;
import com.example.jose.myandroidfirebasedbreal.ViewHolder.MyRecyclerViewHolder;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getReference("MyGalosoft");
    ...
    private void postComment() {
        ...
        String commnent = edt_content.getText().toString();

        Post post = new Post(title, commnent);
            ...
            protected void onBindViewHolder(@NonNull MyRecyclerViewHolder holder, int position, @NonNull final Post model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position) {
                        ...
                        Log.d("Key selected", " " + selectedKey);
